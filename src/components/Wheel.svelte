...
<div class="wheel">
  ...
  <WheelRadius inner={size} angle={140} length={30.8} color="#485e88" />
  <DocumentLine x1={0.25} y1={15.4} x2={38.35} y2={15.4} endXOffset={50} startColor="#485e88" endColor="#485e88"/>
